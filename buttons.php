...
<head>
  ...
  <title>BRUFSOFT - Dashboard</title>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">BRUFSOFT</div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="buttons.html">Subir Facturas</a>
            <a class="collapse-item" href="cards.html">Mostrar Facturas</a>
          </div>
        </div>
      </li>
...
-->
        ...
        <!--  Page Heading -->
         <!-- <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h4 mb-0 text-gray-800">ARTICULO&nbsp;<input type="text" name="articulo" id="articulos">&nbsp;
              CANTIDAD <input type="number" name="numero">
              
              <input type="submit" value="REGISTRAR" name="buscar">
              </h1>
        ...
        <script>
            ...
            <!-------------------------------------------->
              ...
              <!--  <table id="fresh-table" class="table">
								<thead>
									...
									<th data-field="CÓDIGO" data-sortable="true">CODIGO</th>
									...
									<th data-field="P.UNITARIO" data-sortable="true">P.UNITARIO</th>
            ...
            <article id="main">
						<!--<header style="padding-top: 50px; padding-bottom: 50px;" >
							<h2>Facturacion</h2>
							<p>Creando una factura dinámica con JavaScript</p>
						</header>-->
									...
									<form method="post" action="#">
										...
										<div class="12u$">
											<ul class="actions" style="text-align: center">
                                                ...
                                                <li><input type="button" value="Guardar"  onclick="guardar()" /></li>
											</ul>
										</div>
										<br>
										<br>
      ...
      <!-- End of Main Content -->
        ...
        <script>
         ...
         valores=new Array();
            $('#tabla_factura tr').each(function () {
            ...
            var Impuesto = $(this).find('td').eq(6).html();
            var Total = $(this).find('td').eq(7).html();
            valor=new Array(N,Codigo, Descripcion,Cantidad,Precio,Subtotal,Impuesto,Total);
            valores.push(valor);
});
